...
const ERROR_MESSAGES: Record<string, string> = {
  ...
  ERR_PERIOD_LOCKED: UX_COPY.culture.periodLocked,
  ERR_SEMESTER_LOCKED: UX_COPY.culture.semesterLocked,
  ERR_SEMESTER_FINALIZED: "Semester ini sudah diselesaikan dan tidak dapat diubah.",
  ERR_TEACHER_NOT_ASSIGNED_TO_CLASS: UX_COPY.culture.teacherNotAssigned,
