...
export default function UsersPage() {
  ...
  const loadUsers = useCallback(async () => {
    ...
    try {
      ...
      const msg = err instanceof ApiError ? err.message : "Data pengguna belum dapat dimuat. Silakan coba kembali.";
      setError(msg);
    } finally {
      setLoading(false);
    }
  ...
  const handleCreateUser = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const msg = err instanceof ApiError ? err.message : "Gagal menyimpan pengguna.";
      setModalError(msg);
    } finally {
  ...
  const handleEditUser = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const msg = err instanceof ApiError ? err.message : "Gagal memperbarui pengguna.";
      setModalError(msg);
    } finally {
      setModalLoading(false);
    }
  ...
  const handleResetPassword = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const msg = err instanceof ApiError ? err.message : "Gagal mengatur ulang kata sandi.";
      setModalError(msg);
    } finally {
      setModalLoading(false);
    }
