...
import { unlockSemester } from '@/lib/services/semesterService';
  ...
  return withAuth(req, async (req) => {
    return withRole(['administrator'], req, async () => {
      try {
        ...
        const result = await unlockSemester(id, actorId);
        return successResponse(result, 'Semester unlocked successfully.');
      } catch (error) {
