  ...
  return withAuth(req, async (req) => {
    return withRole(['administrator'], req, async () => {
      try {
        ...
        const result = await exportStudentReport(id, body.academic_year_id, body.semester_id, 'full', actorId);
        return successResponse(result, 'Full report generated successfully.');
      } catch (error) {
