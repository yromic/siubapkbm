  ...
  return withAuth(req, async (req) => {
    return withRole(['administrator'], req, async () => {
      try {
        ...
        const result = await exportStudentReport(id, body.academic_year_id, body.semester_id, 'character', actorId);
        return successResponse(result, 'Character report generated successfully.');
      } catch (error) {
